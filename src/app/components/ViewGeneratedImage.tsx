interface ViewGeneratedImageProps {
  imageUrl: string;
  loading: boolean;
}

export default function ViewGeneratedImage({
  imageUrl,
  loading,
  ...
  return (
    <div className="flex justify-center items-center max-w-[700px] h-[525px] rounded-[1.2rem] overflow-hidden bg-primary-container shadow-custom relative">
      {loading ? (
        ...
        // Show placeholder image if no image has been generated yet
        <img
          src="/img/sbg_background.png"
          alt="Placeholder"
          className="w-full h-full object-cover"
        />
      )}
